...
INSERT INTO shopping_items (category, name, scaling, base_qty, unit_price) VALUES
  ...
  ('Pantry', 'Cooking Oil 5L', 'per_100_2days', 1.5, NULL),
  ('Pantry', 'Crushed Chilli 1kg', 'per_100_2days', 1, NULL),
  ('Pantry', 'Fruit Salad', 'fixed', 1, NULL),
  ('Pantry', 'Crushed Garlic 1kg', 'per_100_2days', 1, NULL),
  ('Pantry', 'Peaches', 'fixed', 1, NULL),
  ('Pantry', 'Crushed Ginger 1kg', 'per_100_2days', 1, NULL),
  ...
  ('Baking', 'Salt', 'per_100_2days', 1, 1.93),
  ('Baking', 'Pepper', 'per_100_2days', 1, NULL),
  ('Cleaning', 'Toilet Paper 40PK', 'per_100_2days', 6, NULL),
  ('Other', 'Glad Wrap', 'per_100_2days', 4, 4.99),
  ('Cleaning', 'Dishwash', 'per_100_2days', 1, NULL),
  ('Other', 'Tin Foil', 'per_100_2days', 4, 2.69),
  ('Cleaning', 'Disinfectant', 'fixed', 1, 4.49),
  ('Other', 'Baking Paper', 'per_100_2days', 2, NULL),
  ('Cleaning', 'Jif Cleanser', 'per_100_2days', 1, NULL),
  ('Other', 'Muslin Cloth', 'fixed', 1, NULL),
  ('Cleaning', 'Toilet Cleaner', 'per_100_2days', 1, NULL),
  ('Cleaning', 'Hand Soap / Handwash', 'per_100_2days', 1, NULL),
  ('Meat', 'Whole Chicken', 'per_100_2days', 20, NULL),
  ('Cleaning', 'Rubbish Bags', 'per_100_2days', 2, NULL),
  ('Meat', 'Mince', 'per_100_2days', 10, NULL),
  ...
  ('Meat', 'Steak', 'per_100_2days', 15, NULL),
  ('Seafood', 'Fish Fillets (Carton)', 'per_100_2days', 2, NULL),
  ('Meat', 'Pork', 'per_100_2days', 15, NULL),
  ...
  ('Cleaning', 'Dishwashing liquid 2ltr', 'per_100_2days', 1, 1.99),
